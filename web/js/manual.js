export const MANUAL_SECTIONS = [
  ...
  {
    id: "map-fidelity",
    title: "Map Labels and Heraldry",
    keywords: ["map", "labels", "citadel", "crest", "lion", "griffin", "eagle", "unicorn", "sanctuary"],
    html: `
      <h3>Special-location labels</h3>
      <p>Location names rotate along the broad direction of their territory and compress slightly when necessary. Hover over a territory with a mouse, or focus it with the keyboard, to display its complete name in the status ribbon above the map.</p>
      <h3>Citadel heraldry</h3>
      <p>The four house shields sit outside the board beside their Citadel territories: Arisilon's Lion, Brynthia's Griffin, Durnin's Eagle, and Zenon's Unicorn. These are newly drawn vector emblems inspired by the original heraldic concept.</p>
    `,
  },
  {
    id: "workspace",
    title: "Window and Workspace",
    keywords: ["layout", "resize", "window", "panels", "divider", "fullscreen", "maximize", "tutorial"],
    html: `
      <h3>Desktop window</h3><p>The Windows edition opens maximized while retaining the normal title bar and taskbar. Resizing the native window causes the game workspace and its contents to reflow automatically.</p>
      <h3>Resizable panels</h3><p>On a sufficiently wide desktop window, drag the dividers between the Map, Tower, and Dashboard. A horizontal divider changes the space shared by Current Adventurer and Chronicle. Keyboard users may focus a divider and use the arrow keys.</p><p>Use the Layout button for Balanced, Map Focus, Tower Focus, Dashboard Focus, or Equal Columns. The selected proportions are saved on the current device.</p>
      <h3>Guided tour</h3><p>On desktop, the tour docks beside the game and the tabletop shrinks to make room. On narrower windows, it docks at the bottom and reserves space rather than hiding the active panel.</p>
    `,
  },
  {
    id: "quick-start",
...

  {
    ...
    title: "Interactive Board and Movement",
    keywords: ["map", "board", "territory", "adjacent", "legal move", "dragon pawn", "zoom", "pegasus"],
    html: `
      <p>The Deluxe board reconstructs the original circular four-kingdom layout with separate irregular territories, four long Frontier spaces, four Dark Tower spaces, and the original relative placement of Citadels, Sanctuaries, Bazaars, Tombs, and Ruins.</p>
      <ul>
        <li>Gold outlines show legal adjacent destinations for the current player.</li>
        <li>Select the current territory to remain there and use its location again.</li>
        <li>A Dragon marker blocks its territory until another Dragon attack moves it.</li>
        <li>Foreign Citadels and premature Dark Tower spaces are excluded automatically.</li>
        <li>Frontier direction and missing-key restrictions are enforced automatically.</li>
        <li>Use the +, −, and percentage controls to zoom; drag the board while zoomed.</li>
        <li>When Pegasus is selected, blue outlines show all legal flight destinations.</li>
      </ul>
      <p>Settings can disable movement enforcement for groups that prefer to use an original or printed physical board.</p>
    `,
  },
  {
    id: "app-controls",
    title: "Using This App",
    keywords: ["app", "save", "share", "export", "import", "ipad", "install", "home screen", "display", "wake lock", "correction", "seed", "manual"],
    html: `
      <ul>
        <li>The app autosaves after actions. Use Share / Export Save for a portable JSON backup and Import Save to restore one. On iPad, the share sheet can place the file in Files or iCloud Drive.</li>
        ...
        <li>Settings include Classic 1981 presentation, reduced motion, high contrast, larger text, sound, music, map visibility, and an optional screen wake lock.</li>
        <li>On an iPad, open the GitHub Pages version in Safari and use Share → Add to Home Screen. The Device &amp; iPad panel shows installation and backup guidance.</li>
        <li>Tablet portrait mode uses Map, Tower, Player, and Chronicle tabs to avoid excessive scrolling.</li>
        <li>On Windows, Shared Tower Display opens as a native second app window. In a browser or on iPad, it opens a second browser window and may require popup permission.</li>
